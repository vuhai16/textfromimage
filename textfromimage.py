...
class Snipper(QtWidgets.QWidget):
    def __init__(self, parent=None, flags=Qt.WindowFlags()):
        ...
        self.setWindowTitle("TextFromImage")
        self.setWindowFlags(
...
def notify(msg):
    try:
        Notification(title="TextFromImage", description=msg).send()
        ...
        trayicon.show()
        trayicon.showMessage("TextFromImage", msg, QtWidgets.QSystemTrayIcon.NoIcon)
        trayicon.hide()
